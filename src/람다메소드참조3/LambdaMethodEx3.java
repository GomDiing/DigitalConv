...
/*
 * 메소드 참조에는 생성자 참조를 호출합니다.
 * 메소드 참조 : 클래스 필드, 인스턴스 필드, 매개변수 참조, 생성자 참조
 */

public class LambdaMethodEx3 {
    public static void main(String[] args) {
        // 1개의 인자를 받고 1개의 객체를 반환하 함수형 Interface
        Supplier<TestMember> function0 = TestMember::new;
        TestMember mem0 = function0.get();
        ...
        // 1개의 double형 매개변수를 전달받아 1개의 double형 값을 반환
        DoubleUnaryOperator oper;
        oper = (n) -> Math.abs(n);
        System.out.println(oper.applyAsDouble(-5));
        oper = Math::abs; // Method 참조 표현식
        System.out.println(oper.applyAsDouble(-5));
    }
}
